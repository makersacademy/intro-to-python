...
# | :              | The `:` symbol indicates the function should start now |
...
# @TASK: For each section below, uncomment code and replace
# the `?` with the right operator.

# To uncomment, delete the '#' and ' ' on the start of the
# line.
